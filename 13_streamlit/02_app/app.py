...
# add title
st.title('Machine Learning Application Created By Zeeshan Younas')
st.subheader('This application is used to find the insights of the dataset and to create the visualizations')
...
# Add button to show greeting
if st.button('Click to see the greeting'):
    st.write('Hello, welcome to the application!')
